        ...
        <table class="table-auto w-full border-collapse bg-white text-left text-sm text-gray-500">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <tr class="hover:bg-gray-50" v-for="book in allBook" :key="book.isbn">
                    ...
                    <td class="px-6 py-4 ">
                        <img class="w-20 h-30" :src="`http://34.125.149.37/images/uploads/${book.book_img}`" alt="">
                        {{ book.book_img }}
                    </td>
                    <td class="px-6 py-4 ">
                        {{ book.in_stock }}
...
export default {
    ...
    methods: {
        ...
        delBook(book) {
            axios.delete("http://34.125.149.37/api/editBook/", { params: { isbn: book.isbn } }, {
                headers: {
    ...
    created() {
        console.log("create")
        axios.get("http://34.125.149.37/api/editBook")
            .then(res => {
