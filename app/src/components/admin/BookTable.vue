        ...
        <table class="table-auto w-full border-collapse bg-white text-left text-sm text-gray-500">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <tr class="hover:bg-gray-50" v-for="book in allBook" :key="book.isbn">
                    ...
                    <td class="px-6 py-4 ">
                        <img class="w-20 h-30" :src="`http://localhost/images/uploads/${book.book_img}`" alt="">
                        {{ book.book_img }}
                    </td>
                    <td class="px-6 py-4 ">
                        {{ book.in_stock }}
...
export default {
    ...
    methods: {
        ...
        delBook(book) {
            axios.delete("http://localhost/api/editBook/", { params: { isbn: book.isbn } }, {
                headers: {
    ...
    created() {
        console.log("create")
        axios.get("http://localhost/api/editBook")
            .then(res => {
