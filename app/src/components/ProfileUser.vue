            ...
            <div class="col-md-4 border-right">
                <div class="relative flex flex-column align-items-center text-center p-3 lg:py-5">
                    <img class="rounded-full mt-5 w-56 h-56 lg:w-72 lg:h-72"
                        :src="img_user ? `http://34.125.67.227/images/uploads/${this.img_user}` : `https://upload.wikimedia.org/wikipedia/commons/8/89/Portrait_Placeholder.png`" />
                    <div class="flex mt-3">
                        <div class="row">
...
export default {
    ...
    methods: {
        ...
        changepicture() {
            ...
            axios.put(`http://34.125.67.227/api/changepicture`, formData, { headers: { 'Content-Type': 'multipart/form-data' } })
                .then((res) => {
        ...
        editprofile() {
            swal("Please enter your password:", {
                ...
                .then((value) => {
                    axios.get("http://34.125.67.227/api/verifyuser", { params: { password: value } })
                        .then((res) => {
                            if (res.data) {
        ...
        submit() {
            if (!this.name) {
                ...
                axios.put(`http://34.125.67.227/api/EditProfile`, formData, { headers: { 'Content-Type': 'application/json' } })
                    .then((res) => {
        ...
        changeemail() {
            swal("Please enter your otp:", {
                ...
                .then((value) => {
                    if (value || value=="") {
                        axios.post("http://34.125.67.227/api/verifyOtp/", { otp: value, })
                            .then((res) => {
                                console.log(res.data)
                                swal("Please new email:", {
                                    ...
                                    .then((value) => {
                                        if (value == this.email) {
                                            ...
                                            axios.put(`http://34.125.67.227/api/changeemail/`, { email: value })
                                                .then((res) => {
                                                    this.email = res.data
                                                })
                                                .catch((err) => {
        ...
        sendOtp() {
            ...
            axios.get(`http://34.125.67.227/api/sendOtp/`)
                .then((res) => {
                    console.log(res.data)
                    this.changeemail()
                })
