                    ...
                    <tr v-for="orderlines in orderlines" :key="orderlines.line_id" class="hover:bg-blue-100">
                        ...
                        <td class="px-5 py-5 border-b border-gray-200 text-sm">
                            <p class="text-gray-900 whitespace-no-wrap mt-3">
                                <!-- order date -->
                                <img class="w-20 h-30" :src="`http://34.16.145.46/images/uploads/${orderlines.book_img}`" alt="">
                                {{ orderlines.isbn }}
                            </p>
                        </td>
                        <td class="px-5 py-5 border-b border-gray-200 text-sm">
...
export default {
    ...
    methods: {
        showOrderLine(order_id) {
            ...
            axios.post("http://34.16.145.46/api/orderline", formData, {
                headers: {
        ...
        sort(value){
            console.log(value)
            axios.get(`http://34.16.145.46/api/orderDetails`, {params:{status:value}})
            .then(res => {
    ...
    created() {
        ...
        axios.get(`http://34.16.145.46/api/orderDetails`)
            .then(res => {
                this.orders = res.data
                console.log(this.orders)
            })
