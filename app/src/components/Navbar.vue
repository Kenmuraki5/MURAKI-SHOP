                            ...
                            <div class="py-6 ">
                              <div class="flex  max-w-md bg-white shadow-lg rounded-lg overflow-hidden">
                                <div class="w-1/3 grid items-center">
                                  <img class="" :src="`http://localhost/images/uploads/${item.book_img}`" alt="">
                                </div>
                                <div class="w-2/3 p-4">
            ...
            <div>
              <MenuButton
                ...
                <img v-else class="h-8 w-8 rounded-full"
                  :src="$store.state.image ? `http://localhost/images/uploads/${$store.state.image}` : 'https://upload.wikimedia.org/wikipedia/commons/8/89/Portrait_Placeholder.png'"
                  alt="Profile Image" />
              </MenuButton>
            </div>
