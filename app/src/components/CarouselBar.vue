    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item" style="max-height: 500px;" data-bs-interval="9000">
          <img src="http://34.125.149.37/images/uploads/event3.jpeg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block">
          </div>
        </div>
        <div class="carousel-item" style="max-height: 500px;" data-bs-interval="2000">
          <img src="http://34.125.149.37/images/uploads/event4.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block">
          </div>
        </div>
      </div>
