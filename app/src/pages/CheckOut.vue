                                ...
                                <div class="row">
                                    <div class="col-md-12 col-lg-3 col-xl-3 mb-4 mb-lg-0">
                                        <div class="bg-image hover-zoom ripple rounded ripple-surface">
                                            <img :src="`http://34.125.149.37/images/uploads/${product.book_img}`" class="w-100" />
                                            <a href="#!">
...
export default {
    ...
    methods: {
        ...
        submit() {
            ...
            axios.post('http://34.125.149.37/api/addPayment', form, {
                headers: {
    ...
    async created() {
        try {
            ...
            const res = await axios.get("http://34.125.149.37/api/CheckOut", { params: { cart: this.cart } })
            this.shipping = res.data

            const res1 = await axios.get("http://34.125.149.37/api")
