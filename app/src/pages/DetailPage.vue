        ...
        <div class="container px-5 py-24 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                <img class="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200"
                    :src="products.book_img?`http://localhost:3000/uploads/${products.book_img}`:products.book_img">
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <div class="flex mt-6 pb-5 border-b-2 border-gray-200 mb-5">
                        <div class="flex items-center">
                            ...
                            <div class="form">
                                <input v-model="amount" type="number" class="rounded border appearance-none border-gray-400 py-2 focus:outline-none focus:border-red-500 text-base pl-3 pr-2"/>
                            </div>
                        </div>
                    </div>
                    <div class="flex">
